...
Di sini, kamu akan melakukan simulasi untuk melihat bagaimana berbagai buah dapat dikombinasikan menjadi campuran jus🧃. 
Tetapi bukan hanya sekadar mencampur buah — kamu juga akan belajar konsep matematika kombinasi untuk menghitung banyaknya 
cara memilih sejumlah buah dari sekumpulan buah yang tersedia.
""")
